...
const AddCrime = ({ lat, lng, show, handleClose }) => {
    ...
    return (
        <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Header >
                <Modal.Title style={{ width: "100%", textAlign: "center" }}>Please Add crime details</Modal.Title>
            </Modal.Header>
                ...
                <Form id="add-crime-form">
                    ...
                    <Form.Group className="mb-3" style={{ display: "flex", flexWrap: "wrap" }}>
                        ...
                        <Form.Group className="mb-3" style={{ marginRight: "5rem" }}>
                            ...
                            <Dropdown>
                                <Dropdown.Toggle variant="success" id="dropdown-basic" value={formData.type}>
                                    {formData.type}
                                </Dropdown.Toggle>

                                <Dropdown.Menu style={{ overflow: "auto", maxHeight: "15vh" }}>
                                    {crimeTypes.map((crime, idx) => {
                                        return <Dropdown.Item key={idx} name="type" onClick={handleSelectValue} value={crime}>{crime}</Dropdown.Item>
                                    })}
                                </Dropdown.Menu>
                            </Dropdown>
                        </Form.Group>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Dropdown>
                                ...
                                <Dropdown.Menu>
                                    <Dropdown.Item name="severity" onClick={handleSelectValue} value="low">Low</Dropdown.Item>
                                    <Dropdown.Item name="severity" onClick={handleSelectValue} value="medium">Medium</Dropdown.Item>
                                    <Dropdown.Item name="severity" onClick={handleSelectValue} value="high">High</Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown>
                        </Form.Group>
                    </Form.Group>
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control value={formData.landmarks} name="landmarks" onChange={inputEvent} type="text" placeholder="Specify Landmarks" />
                    </Form.Group>
            ...
            <Modal.Footer style={{ display: "flex", justifyContent: "center" }}>
                <Button variant="primary" type="submit" form="add-crime-form" onClick={SubmitDetails}>
                    Add Crime
                </Button>
            </Modal.Footer>
